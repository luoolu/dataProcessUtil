...
if __name__ == "__main__":
    src_dir = '/home/xkjs2/NDisk/lsw/dataset/COCO_keli/ning71x-16-0672'
    dst_dir = '/home/xkjs2/NDisk/lsw/dataset/COCO_keli/ning71x-16-0672_resize'
    ...
    for key in exts.keys():
        for img_file in glob.glob(os.path.join(src_dir, '*.' + key)):
            ...
            print(f"Processing {file_name} {i}/{len(filesnames)}" )
